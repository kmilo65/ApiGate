...
-- These tables are required by the @auth/supabase-adapter
-- IMPORTANT: These must be in the "public" schema, not "auth" schema

-- Create NextAuth users table (in public schema)
...
-- Create NextAuth accounts table (in public schema)
...
-- Create NextAuth sessions table (in public schema)
...
-- Create NextAuth verification tokens table (in public schema)
